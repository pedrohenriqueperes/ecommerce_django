...
class Cliente(models.Model):
    ...
    usuario = models.OneToOneField(User, null=True, blank=True, on_delete=CASCADE)
...
class ItensPedido(models.Model):
    ...
    quantidade = models.IntegerField(default=0)
    pedido = models.ForeignKey(Pedido, null=True, blank=True, on_delete=SET_NULL)


    def __str__(self):
        return f"Id pedido: {self.pedido.id} - Produto: {self.item_estoque.produto}, Tamanho: {self.item_estoque.tamanho}, Cor: {self.item_estoque.cor.nome}"
